...
<div class="row">
  <div class="col-md-6 col-sm-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body"> @foreach ($pages as $page)
        <div class="page row">
      ...
      <div class="col-md-6 col-sm-6"> <div class="panel panel-default">
          ...
          <div class="page">
            <a href="{{ URL('articles/'.$article->id) }}" target="_blank">
              ...
              <form action="{{ URL('admin/articles/'.$article->id) }}" method="POST" style="display: inline;">
                <input name="_method" type="hidden" value="DELETE">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"> <button type="submit" class="btn btn-danger">Delete</button>
              </form>
            </div>
            @endforeach
          </div>
